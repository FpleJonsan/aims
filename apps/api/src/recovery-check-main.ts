...
import { Pool } from "pg";
import { createDocumentStorage } from "./infrastructure/configuration/provider-boundary.js";
...
import { assertProtectedDatabaseTransport } from "./infrastructure/configuration/runtime-foundation.js";
...
async function main(){
  ...
  assertProtectedDatabaseTransport("RECOVERY_CHECK_DATABASE_URL",connectionString);
