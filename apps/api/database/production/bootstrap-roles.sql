...
GRANT CONNECT ON DATABASE :"DBNAME" TO aims_migrator,aims_app,aims_finance_runtime,aims_payment_runtime;
...
GRANT USAGE ON SCHEMA public TO aims_app,aims_finance_executor,aims_finance_runtime,aims_payment_executor,aims_payment_runtime;
