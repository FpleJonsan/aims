...
| Metrics/alerting | P10 SIGNAL FOUNDATION PASS / P11 NOT STARTED | Bounded API, DB, worker, outbox, document, AI, auth, Finance Control and distinct Payment/recovery inputs exist; Telegram backlog queries are index-supported and sampled. P11 owns thresholds/routes and P13 owns private exposure. |
