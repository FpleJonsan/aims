...
| C-010 | P8 requires AI governance hardening before Production AI may be enabled | CONFIRMED DECISION | Current AI remains optional/advisory and AI OFF is viable, but provider deadlines/bounds and Validation/Risk evidence validation require code hardening. No provider is selected. |
