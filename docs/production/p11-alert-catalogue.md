...
Status: PASS / FROZEN provider-neutral specification; current deployment target is schema 71.
...
schema contract, currently schema 71 at
`071_p20_7a_enterprise_ui_contracts`. No specification is a business rule
...
| `SCHEMA_VERSION_MISMATCH` | ALERT / HIGH | schema readiness | Deterministic | runtime matches current schema contract: 71 / `071_p20_7a_enterprise_ui_contracts` | Always | DBA / schema | P13 |
