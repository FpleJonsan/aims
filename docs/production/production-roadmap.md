...
| P7 | Decision PASS: no Redis; separately authorize PostgreSQL-backed worker implementation for reliable outbox/scanning, supervision, retries, backlog/final failure and graceful deployment | D-008 confirmed, D-014, P5-P6 | Crash/restart/duplicate delivery cannot corrupt state; backlog observable; synchronous financial authority unchanged | Failure injection, lease recovery, poison work, shutdown and P15 capacity evidence |
