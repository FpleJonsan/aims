...
Status: DECISION PASS — authorized implementation complete and frozen. The capability was introduced at schema 57; the current Enterprise release target is schema 71 at `071_p20_7a_enterprise_ui_contracts`.
